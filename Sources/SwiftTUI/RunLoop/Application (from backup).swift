...
public init<I: View>(rootView: I) {
 ...
 @discardableResult
 @inline(__always)
 public convenience init<I: View>(_ view: I) async {
 ...
 @discardableResult
 @inline(__always)
 public convenience init<I: View>(@ViewBuilder _ view: @escaping () -> I) async {
...
public protocol AppView: View {
 init()
}

public extension SwiftTUI.AppView {
 
 static func main() async {
  await Application(rootView: Self()).start()
 }
}
...
public extension App {
 @inline(__always)
 static func main() async {
  await Application(Self.init)
 }

 
 @MainActor
 @inline(__always)
 static func main(runLoopType: Application.RunLoopType) {
  Application(runLoopType: runLoopType, Self.init)
 }
}
